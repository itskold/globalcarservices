            ...
            <div className="space-y-8">
              <div>
                ...
                <Card className="mb-8">
                  <CardContent className="grid grid-cols-2 gap-4 p-6">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm text-gray-600">Brandstof</p>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="text-sm text-gray-600">Zitplaatsen</p>
                ...
                <div className="space-y-6">
                  <div>
                    <h2 className="text-2xl font-semibold mb-4">Specificaties</h2>
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <h3 className="font-medium text-[#050b20]">Motor</h3>
                        <p className="text-gray-600">{car.specifications.engine}</p>
                      </div>
                      <div>
                        <h3 className="font-medium text-[#050b20]">Vermogen</h3>
                        <p className="text-gray-600">{car.specifications.power}</p>
                      </div>
                      <div>
                        <h3 className="font-medium text-[#050b20]">Verbruik</h3>
                        <p className="text-gray-600">{car.specifications.consumption}</p>
                      </div>
                      <div>
                        <h3 className="font-medium text-[#050b20]">Kleur</h3>
                        <p className="text-gray-600">{car.specifications.color}</p>
                      </div>
                      <div>
                        <h3 className="font-medium text-[#050b20]">Interieur</h3>
                        <p className="text-gray-600">{car.specifications.interior}</p>
                      </div>
                      <div>
                        <h3 className="font-medium text-[#050b20]">Deuren</h3>
                  ...
                  <div>
                    <h2 className="text-2xl font-semibold mb-4">Opties en uitrusting</h2>
                  ...
                  <div>
                    <h2 className="text-2xl font-semibold mb-4">Inbegrepen</h2>
                    <div className="grid grid-cols-2 gap-2">
