    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-br from-[#050b20] to-[#0a1530] text-white py-20 rounded-t-[4rem]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Voertuigverhuur</h1>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Professionele voertuigverhuur voor al uw transport- en mobiliteitsbehoeften
            </p>
          </div>
        </div>
      </section>
              ...
              <Card className="hover:shadow-xl transition-all duration-300 group-hover:scale-[1.02]">
                <CardContent className="pt-6">
                  <div className="text-center">
                    ...
                    <h3 className="text-xl font-semibold mb-2">Bestelwagens</h3>
                    <p className="text-gray-600 text-sm">
                      {vehiclesByCategory["Bestelwagen"]?.length || 0} beschikbare modellen
                    </p>
                  </div>
                </CardContent>
              </Card>
            ...
            <Link href="/rental/box" className="group">
              <Card className="hover:shadow-xl transition-all duration-300 group-hover:scale-[1.02]">
                <CardContent className="pt-6">
                  <div className="text-center">
                    <Package className="w-12 h-12 mx-auto mb-4 text-[#95c8e2]" />
                    <h3 className="text-xl font-semibold mb-2">Bakwagens</h3>
                    <p className="text-gray-600 text-sm">
                      {vehiclesByCategory["Bakwagen"]?.length || 0} beschikbare modellen
                    </p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="hover:shadow-xl transition-all duration-300 group-hover:scale-[1.02]">
                <CardContent className="pt-6">
                  <div className="text-center">
                    ...
                    <h3 className="text-xl font-semibold mb-2">Minibussen</h3>
                    <p className="text-gray-600 text-sm">
                      {vehiclesByCategory["Minibus"]?.length || 0} beschikbare modellen
                    </p>
                  </div>
                </CardContent>
              </Card>
            ...
            <Link href="/rental/refrigerated" className="group">
              <Card className="hover:shadow-xl transition-all duration-300 group-hover:scale-[1.02]">
                <CardContent className="pt-6">
                  <div className="text-center">
                    <Package className="w-12 h-12 mx-auto mb-4 text-[#95c8e2]" />
                    <h3 className="text-xl font-semibold mb-2">Koelwagens</h3>
                    <p className="text-gray-600 text-sm">
                      {vehiclesByCategory["Koelwagen"]?.length || 0} beschikbare modellen
                    </p>
                  </div>
                </CardContent>
              </Card>
      ...
      <section className="py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-gray-600">
            {filteredVehicles.length} van {vehicles.length} voertuigtypes gevonden
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-[#050b20] mb-6">Huurvoorwaarden</h2>
              <div className="space-y-4 text-gray-700">
                <div className="flex items-start">
                  <div className="w-2 h-2 bg-[#95c8e2] rounded-full mr-3 mt-2"></div>
                  <div>
                    <strong>Kilometers:</strong> 200 km inbegrepen per dag (toeslag 0,21€/km)
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-2 h-2 bg-[#95c8e2] rounded-full mr-3 mt-2"></div>
                  <div>
                    <strong>Beschikbare periodes:</strong> ½ dag (4u), dag, weekend, week, maand
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-2 h-2 bg-[#95c8e2] rounded-full mr-3 mt-2"></div>
                  <div>
                    <strong>Opties:</strong> Navigatie, airco, CarPlay, trekhaak volgens model
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-2 h-2 bg-[#95c8e2] rounded-full mr-3 mt-2"></div>
                  <div>
                    <strong>Vereiste documenten:</strong> Geldig rijbewijs en identiteitsbewijs
                  </div>
                </div>
              </div>
              <Button asChild className="mt-6 bg-[#050b20] hover:bg-[#0a1530] text-white">
                <Link href="/rental/conditions">Volledige voorwaarden</Link>
              </Button>
            </div>
            <div>
              <img
      ...
      <section className="py-16 bg-[#050b20] text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold mb-4">Klaar om te huren?</h2>
          <p className="text-xl text-gray-300 mb-8">
            Bekijk onze beschikbaarheid en reserveer direct online uw gewenste voertuig
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild size="lg" className="bg-[#95c8e2] hover:bg-[#7bb8d9] text-[#050b20] font-semibold">
              <Link href="/#search">Beschikbaarheid bekijken</Link>
            </Button>
            <Button
              asChild
              variant="outline"
